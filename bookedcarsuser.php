        ...
        <tbody>
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li><a href="<?php echo SITEURL;?>editrentedcars.php?id=<?php echo $id; ?>"><i class="bi bi-pencil"></i></a></li>
                                    <li><a href="<?php echo SITEURL;?>deleterentedcars.php?id=<?php echo $id; ?>"><i class="bi bi-trash"></i></a></li>
                                </ul>
                            </td>
                        </tr>

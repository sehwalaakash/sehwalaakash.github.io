...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vehiclemodel" value="<?php echo $vehiclemodel; ?>" id="vehiclemodel" placeholder="Vehicle Model">
                    </div>
                    <div class="form-group">
                        <label for="vehiclenumber">Vehicle Number</label>
                        <input type="text" class="form-control" name="vehiclenumber" id="vehiclenumber" value="<?php echo $vehiclenumber; ?>" placeholder="Vehicle Number">
                    </div>
                    <div class="form-group">
                        <label for="seatingcapacity">Seating Capacity</label>
                        <input type="text" class="form-control" name="seatingcapacity" id="seatingcapacity" value="<?php echo $seatingcapacity; ?>" placeholder="Seating Capacity">
                    </div>
                    <div class="form-group">
                        <label for="rentperday">Rent Per Day</label>
                        <input type="text" class="form-control" id="rentperday" name="rentperday" value="<?php echo $rentperday; ?>" placeholder="Rent Per Day">
                    </div>
    ...
    if (isset($_POST['update'])) {
        ...
        $vehiclemodel1 = $_POST['vehiclemodel'];
        $vehiclenumber1 = $_POST['vehiclenumber'];
        $seatingcapacity1 = $_POST['seatingcapacity'];
        $rentperday1 = $_POST['rentperday'];

        // 2. SQL Query to Save the data into the Database

        // UPDATE `cars` SET `rentperday` = '5000' WHERE `cars`.`id` = 1 
        $sql = "UPDATE cars SET
                        model='$vehiclemodel1',
                        number='$vehiclenumber1',
                        seatingcapacity='$seatingcapacity1',
                        rentperday='$rentperday1'
                    WHERE id='$id'
            ";
        ...
        if ($res == TRUE) {
            ...
            // Redirect Page to Manage Cars Page
            header("location:" . SITEURL . "editcars.php");
        }
    }
